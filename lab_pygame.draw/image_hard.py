...
#needle() 150, 400, 250 (координаты центра, диаметр)
#cat() 160, 580, 130
#man() 350, 400, 170   , True - зеркальное отображение

needles = [[50, 370, 80], [300, 390, 80], [170, 420, 250], [110 , 470 , 140], [190, 520, 140]]
men = [[400, 330, 50], [490, 350, 50], [430, 380, 50], [470, 420, 50], [405, 415, 50], [330, 400, 50], [300, 480, 50], [370, 490, 140]]
cats = [[180, 580, 100], [145, 680, 100], [-20, 620, 100], [320, 730, 100], [540, 710, 100]]

for i in needles: needle(i[0], i[1], i[2])
for i in men: man(i[0], i[1], i[2])
for i in cats: cat(i[0], i[1], i[2])
